  ...
  <section id="app" class="obra_detalle san_honorat_24">
    ...
    <section class="container caracteristicas">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <p data-aos="fade-up">
            Este ático dúplex está distribuido en 2 plantas, en la primera planta encontramos un amplio espacio de salón
            comedor con la cocina abierta donde poder disfrutar de tu vida cotidiana, amigos y familia con el mar de
            fondo, también tenemos una habitación en suite con armarios empotrados y baño completo, todo con salida a un
            agradable balcón con unas vistas espectaculares al mar.
          </p>
          <p data-aos="fade-up">
            En la segunda planta tenemos 2 habitaciones en suite con sus respectivos baños y salida a un balcón desde
            que te puedes quedar contemplando la belleza del centro histórico de Sitges y el mar.
          </p>
        </div>
      </div>
          ...
          <div id="carouselPlanosMobile" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item active">
                ...
                <img src="./img/obras-individuales/san-honorat-24/slide-mobile/departamento-1.jpg" class="d-block w-100"
                  alt="departamento 1 mobile a">
              </div>

              <div class="carousel-item">
                <h2 class="bebas">DEPARTAMENTO 2</h2>
                <img src="./img/obras-individuales/san-honorat-24/slide-mobile/departamento-2.jpg" class="d-block w-100"
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <img class="img-fluid plano" src="./img/obras-individuales/san-honorat-24/departamento-1-desktop.jpg"
              alt="departamento-1">
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <img class="img-fluid" src="./img/obras-individuales/san-honorat-24/departamento-2-desktop.jpg"
              alt="departamento-2">
          </div>
        </div>
    ...
    <section class="container galeria">
      ...
      <div class="row">
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/balcon-mar-large.jpg"
            data-lightbox="sanhonorat" data-title="Balcón al Mar San Honorat 24"
            data-alt="balcon al mar San Honorat 24 large">
            <img class="img-fluid" src="./img/obras-individuales/san-honorat-24/balcon-mar.jpg"
              alt="balcon mar San Honorat 24">
            <div class="content">
        ...
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/vista-large.jpg"
            data-lightbox="sanhonorat" data-title="Vista San Honorat 24" data-alt="vista San Honorat 24 large">
      ...
      <div class="row content_imgs">
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/balcon-large.jpg"
            data-lightbox="sanhonorat" data-title="Balcón San Honorat 24" data-alt="balcon San Honorat 24 large">
        ...
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/cocina-large.jpg"
            data-lightbox="sanhonorat" data-title="Cocina San Honorat 24" data-alt="Cocina San Honorat 24 large">
      ...
      <div class="row">
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/bano-large.jpg" data-lightbox="sanhonorat"
            data-title="Baño San Honorat 24" data-alt="Baño San Honorat 24 large">
        ...
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/habitacion-large.jpg"
            data-lightbox="sanhonorat" data-title="Habitación San Honorat 24"
            data-alt="Habitación San Honorat 24 large">
            <img class="img-fluid" src="./img/obras-individuales/san-honorat-24/habitacion.jpg"
              alt="Habitación San Honorat 24">
            <div class="content">
      ...
      <div class="row content_imgs">
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/fachada-large.jpg"
            data-lightbox="sanhonorat" data-title="Fachada San Honorat 24" data-alt="Fachada San Honorat 24 large">
            <img class="img-fluid" src="./img/obras-individuales/san-honorat-24/fachada.jpg"
              alt="Fachada San Honorat 24">
            <div class="content">
        ...
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/terraza-large.jpg"
            data-lightbox="sanhonorat" data-title="Terraza San Honorat 24" data-alt="Terraza San Honorat 24 large">
            <img class="img-fluid" src="./img/obras-individuales/san-honorat-24/terraza.jpg"
              alt="Terraza San Honorat 24">
            <div class="content">
      ...
      <div class="row">
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/cocina-2-large.jpg"
            data-lightbox="sanhonorat" data-title="Cocina 2 San Honorat 24" data-alt="Cocina 2 San Honorat 24 large">
            <img class="img-fluid" src="./img/obras-individuales/san-honorat-24/cocina-2.jpg"
              alt="cocina 2 San Honorat 24">
            <div class="content">
              <h4 class="bebas">cocina</h4>
            </div>
          </a>
        ...
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/habitacion-2-large.jpg"
            data-lightbox="sanhonorat" data-title="Habitación 2 San Honorat 24"
            data-alt="Habitación 2 San Honorat 24 large">
            <img class="img-fluid" src="./img/obras-individuales/san-honorat-24/habitacion-2.jpg"
              alt="Habitación 2 San Honorat 24">
            <div class="content">
              <h4 class="bebas">habitación</h4>
            </div>
          </a>
      ...
      <div class="row content_imgs">
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/balcon-2-large.jpg"
            data-lightbox="sanhonorat" data-title="Balcon 2 San Honorat 24" data-alt="Balcon 2 San Honorat 24 large">
            <img class="img-fluid" src="./img/obras-individuales/san-honorat-24/balcon-2.jpg"
              alt="Balcon 2 San Honorat 24">
            <div class="content">
        ...
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/san-honorat-24/habitacion-3-large.jpg"
            data-lightbox="sanhonorat" data-title="Habitación 3 San Honorat 24"
            data-alt="Habitación 3 San Honorat 24 large">
            <img class="img-fluid" src="./img/obras-individuales/san-honorat-24/habitacion-3.jpg"
              alt="Habitación 3 San Honorat 24">
            <div class="content">
              <h4 class="bebas">habitación</h4>
            </div>
          </a>
