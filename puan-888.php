...
<head>
  ...
  <title>VQZ - Desarrollos - Puan 888 - CABA</title>
...
<body>
  ...
  <section id="app" class="obra_detalle aranguren_1061 muniz_1060 puan_888">
    ...
    <section class="container caracteristicas">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <p data-aos="fade-up">
            Edificio de viviendas a metros del Parque Chacabuco. Unidades de 1 y 2 ambientes de 16 unidades con local comercial en PB
          </p>
          <p data-aos="fade-up">
            Además, el proyecto combina diseño moderno y practicidad, con espacios bien aprovechados y detalles pensados para el día a día.
          </p>
          <p data-aos="fade-up">
            La planta baja suma un local comercial que aporta movimiento y comodidad al entorno, mientras que las 16 unidades ofrecen una propuesta ideal tanto para vivir como para invertir en una zona con excelente conectividad y servicios.
          </p>
        </div>
      </div>
    ...
    <section class="container galeria">
      ...
      <div class="row">
        <div class="col-md-12">
          <a
            data-aos="fade-up"
            href="./img/obras-individuales/puan-888/puan-1.jpg"
            data-lightbox="puan"
            data-title="Vista Aerea Puan 888"
            data-alt="Vista Aerea Puan 888 large">
            <img class="img-fluid" src="./img/obras-individuales/puan-888/puan-1.jpg" alt="Vista Aerea Puan 888">
            <div class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <a
            data-aos="fade-up"
            href="./img/obras-individuales/puan-888/puan-2.jpg"
            data-lightbox="puan"
            data-title="Frente Puan 888"
            data-alt="Frente Puan 888 large">
            <img class="img-fluid" src="./img/obras-individuales/puan-888/puan-2.jpg" alt="Frente Puan 888">
            <div class="content">
