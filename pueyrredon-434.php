...
<body>
  ...
  <section id="app" class="obra_detalle aranguren_1061 pueyrredon_434">
    ...
    <section class="first_section video_content">
      ...
      <div class="obra_finalizada">
        <span class="bebas">Obra Finzalizada</span>
      </div>
          ...
          <div id="carouselPlanosMobile" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
              ...
              <div class="carousel-item active">
                ...
                <img src="./img/obras-individuales/pueyrredon-434/slide-mobile/slide-1-mobile.jpg" class="d-block w-100"
              ...
              <div class="carousel-item">
                ...
                <img src="./img/obras-individuales/pueyrredon-434/slide-mobile/slide-2-mobile.jpg" class="d-block w-100"
              ...
              <div class="carousel-item">
                ...
                <h4 class="bebas">3 ambientes</h4>
                <img src="./img/obras-individuales/pueyrredon-434/slide-mobile/slide-3-mobile.jpg" class="d-block w-100"
              ...
              <div class="carousel-item">
                ...
                <h4 class="bebas">4 ambientes</h4>
                <img src="./img/obras-individuales/pueyrredon-434/slide-mobile/slide-4-mobile.jpg" class="d-block w-100"
              ...
              <div class="carousel-item">
                ...
                <h4 class="bebas">3 ambientes</h4>
                <img src="./img/obras-individuales/pueyrredon-434/slide-mobile/slide-5-mobile.jpg" class="d-block w-100"
              ...
              <div class="carousel-item">
                ...
                <h4 class="bebas">4 ambientes</h4>
                <img src="./img/obras-individuales/pueyrredon-434/slide-mobile/slide-6-mobile.jpg" class="d-block w-100"
                  alt="slide mobile pueyrredon 434 - 6">
              </div>

            </div>
            <button class="carousel-control-prev" type="button" data-bs-target="#carouselPlanosMobile"
              data-bs-slide="prev">
              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
              <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#carouselPlanosMobile"
              data-bs-slide="next">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 content_plano">
            ...
            <div data-aos="fade-up" class="content_map">
              <img class="img-fluid" src="./img/obras-individuales/pueyrredon-434/planos-pueyrredon-434.jpg"
                alt="plano Honorio Pueyrredon 434">

              <svg version="1.1" id="map1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 271 150" style="enable-background:new 0 0 271 150;" xml:space="preserve">
                <polygon data-plano="1" data-plano-title="4 ambientes" data-plano-floor="PISO 13 FRENTE"
                  class="map transition" points="248.93,0.81 248.93,5.36 270.1,5.36 270.1,144.42 249.02,144.08 248.93,149.19 73.49,149.14 
									73.49,86.17 0.9,86.35 0.9,0.81 " />
              </svg>

              <svg version="1.1" id="map2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 288 149" style="enable-background:new 0 0 288 149;" xml:space="preserve">
                <path data-plano="2" data-plano-title="3 ambientes" data-plano-floor="PISO 14 CONTRAFRENTE"
                  class="map transition" d="M287.5,0.59v85.6l-81-0.41l-0.14,62.59l-187.9,0.05l-0.09-5.38l-17.6,0.29L0.5,5.28l17.97,0.55V0.86L287.5,0.59
									z" />
              </svg>

              <svg version="1.1" id="map3" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 206 151" style="enable-background:new 0 0 206 151;" xml:space="preserve">
                <path data-plano="3" data-plano-title="4 ambientes" data-plano-floor="PISOS 3 AL 12 FRENTE"
                  class="map transition"
                  d="M184.86,1.03l0.02,4.86L205.5,6v138.32l-20.79,0.23v5.2L8.49,149.97L8.3,87.59H0.5V1.03H184.86z" />
              </svg>

              <svg version="1.1" id="map4" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 225 149" style="enable-background:new 0 0 225 149;" xml:space="preserve">
                <path data-plano="4" data-plano-title="3 ambientes" data-plano-floor="PISOS 3 AL 12 CONTRAFRENTE"
                  class="map transition"
                  d="M224.34,0.6v84.93h-17.51v62.87H17.48v-4.41l-16.82-0.28V5.29l17.1-0.28l0.28-4.41H224.34z" />
              </svg>

              <svg version="1.1" id="map5" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 197 150" style="enable-background:new 0 0 197 150;" xml:space="preserve">
                <path data-plano="5" data-plano-title="4 ambientes" data-plano-floor="PISO 2 FRENTE"
                  class="map transition"
                  d="M196.49,5.53v138.93h-20.81v5.03L0.51,148.83v-64.6l12.06-0.5L12.41,0.5h163.28l-0.03,5.12L196.49,5.53z" />
              </svg>

              <svg version="1.1" id="map6" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                x="0px" y="0px" viewBox="0 0 225 150" style="enable-background:new 0 0 225 150;" xml:space="preserve">
                <path data-plano="6" data-plano-title="3 ambientes" data-plano-floor="PISO 2 CONTRAFRENTE"
          ...
          <div data-aos="fade-up" class="col-sm-6 content_render">
            ...
            <img data-render="1" class="img-fluid render" src="./img/obras-individuales/pueyrredon-434/render-1.jpg"
              alt="render 1">

            <img data-render="2" class="img-fluid render" src="./img/obras-individuales/pueyrredon-434/render-2.jpg"
              alt="render 2">

            <img data-render="3" class="img-fluid render" src="./img/obras-individuales/pueyrredon-434/render-3.jpg"
              alt="render 3">

            <img data-render="4" class="img-fluid render" src="./img/obras-individuales/pueyrredon-434/render-4.jpg"
              alt="render 4">

            <img data-render="5" class="img-fluid render" src="./img/obras-individuales/pueyrredon-434/render-5.jpg"
              alt="render 5">

            <img data-render="6" class="img-fluid render active"
              src="./img/obras-individuales/pueyrredon-434/render-6.jpg" alt="render 6">
    ...
    <section class="container galeria">
      ...
      <div class="row">
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/pueyrredon-434/fachada-large.jpg"
            data-lightbox="pueyrredon" data-title="Fachada Honorio Pueyrredon 434"
            data-alt="fachada Honorio Pueyrredon 434 large">
            <img class="img-fluid" src="./img/obras-individuales/pueyrredon-434/fachada.jpg"
              alt="fachada Honorio Pueyrredon 434">
            <div class="content">
        ...
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/pueyrredon-434/interior-large.jpg"
            data-lightbox="pueyrredon" data-title="Interior Honorio Pueyrredon 434"
            data-alt="Interior Honorio Pueyrredon 434 large">
            <img class="img-fluid" src="./img/obras-individuales/pueyrredon-434/interior.jpg"
              alt="Interior Honorio Pueyrredon 434">
            <div class="content">
      ...
      <div class="row content_imgs">
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/pueyrredon-434/cocina-large.jpg"
            data-lightbox="pueyrredon" data-title="Cocina Honorio Pueyrredon 434"
            data-alt="Cocina Honorio Pueyrredon 434 large">
            <img class="img-fluid" src="./img/obras-individuales/pueyrredon-434/cocina.jpg"
              alt="Cocina Honorio Pueyrredon 434">
            <div class="content">
        ...
        <div class="col-md-6">
          <a data-aos="fade-up" href="./img/obras-individuales/pueyrredon-434/bano-large.jpg" data-lightbox="pueyrredon"
            data-title="Baño Honorio Pueyrredon 434" data-alt="Baño Honorio Pueyrredon 434 large">
            <img class="img-fluid" src="./img/obras-individuales/pueyrredon-434/bano.jpg"
              alt="Baño Honorio Pueyrredon 434">
            <div class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <a data-aos="fade-up" href="./img/obras-individuales/pueyrredon-434/hall-large.jpg" data-lightbox="pueyrredon"
            data-title="Hall Honorio Pueyrredon 434" data-alt="Hall Honorio Pueyrredon 434 large">
            <img class="img-fluid" src="./img/obras-individuales/pueyrredon-434/hall.jpg"
              alt="Hall Honorio Pueyrredon 434">
            <div class="content">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 offset-md-2">
            ...
            <p data-aos="fade-up">
              Este barrio se encuentra en el medio de la Ciudad de Buenos Aires. Debe su nombre a la pulpería que en
              1821 instaló don Nicolás Vila en la esquina de las actuales calles Rivadavia y Emilio Mitre, que era
              reconocida por su típica veleta en forma de caballito.
            </p>

            <p data-aos="fade-up">
              Como todos los barrios del oeste, también éste progresó en forma notable con la llegada del ferrocarril,
              que desde 1857 atravesó el barrio adoptando el nombre de la famosa pulpería para su estación en el lugar.
            </p>
          </div>
        </div>
      </div>
