...
<head>
	...
	<meta name="description" content="Conocé todos los proyectos desarrollados a lo largo de nuestros 35 años de experiencia.">
		  	...
		  	<div class="col-md-10 offset-md-1">
		  		<div class="row">
		  			...
		  			<!-- Morelos -->
						...
						<!-- goyena -->
						<div data-aos="fade-up" class="col-sm-6 col-lg-4 item_project">
							<img class="img-fluid img_listado" src="./img/obras/goyena.jpg" alt="listado goyena">
							<div class="content_data">
								<h3 class="bebas">pedro <br>goyena <br>607</h3>
								<div class="caracteristica">
									<img class="img-fluid" src="./img/home/icono-argentina.png" alt="icono argentina goyena">
									<p>argentina</p>
								</div>
							</div>
						</div>
						...
						<!-- formosa -->
						<div data-aos="fade-up" class="col-sm-6 col-lg-4 item_project">
							<img class="img-fluid img_listado" src="./img/obras/formosa.jpg" alt="listado formosa">
							<div class="content_data">
								<h3 class="bebas">formosa <br>272</h3>
								<div class="caracteristica">
									<img class="img-fluid" src="./img/home/icono-argentina.png" alt="icono argentina formosa">
									<p>argentina</p>
								</div>
							</div>
						</div>
